...
1. [Open the ROM](Getting-Started#1-open-the-rom-and-save-a-project)
2. [Find the graphics](Getting-Started#2-find-the-graphics)
3. [A palette from a save state](Getting-Started#3-take-a-palette-from-a-save-state)
